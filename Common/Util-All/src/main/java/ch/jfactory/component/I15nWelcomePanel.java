...
public class I15nWelcomePanel extends GradientBackgroundPanel
{
     ...
     * @param commandManager if the commands are based on {@link ActionCommand} implementations. Otherwise {@link ActionManager} is used.
     */
...
//                }
    ...
    private void paintUpperRightLogo( final Graphics2D g2 )
    {
        if ( upperRightLogo != null )
        {
            ...
            g2.drawImage( upperRightLogo, getWidth() - width - 20, ( BORDER_HEIGHT - height ) / 2, width, height, this );
        }
    }
