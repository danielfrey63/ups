...
public class CodedNote implements Note
{
    ...
    /**
     * Accepts a coded note like <code>Finished..., 10, #008000, false</code>. The first token is parsed to the message, the second into the percentage, the third into the color.
     *
