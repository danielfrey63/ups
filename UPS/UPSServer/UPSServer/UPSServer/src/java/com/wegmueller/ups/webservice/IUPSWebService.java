...
public interface IUPSWebService {
     ...
     * @return                          true, fals die App mit dem Server kommunizieren kann,
     *                                      false falls eine neue Version nötig ist
    ...
    /**
     * Gib alle gespeicherten Pruefungssessionen zurück
     * Der Server überprüft vorher ob schon irgendwelche Daten
     * gecached sind, wenn ja liefert er die Pruefungssessions-Daten
     * aus der Datenbank
     *
    ...
    /**
     * Liefert die eingereichte Prufungsliste eines Studenten
     * oder null, wenn keine Liste eingereicht wurde
    ...
    /**
     * Einrichten eines Mapping's zwischen LDAP und OIS-Konto
     * Nach diesem Mapping kann der LDAP-User mit
     * seinen Konto angaben auf OIS-Daten mit den
     * gemappten Konto infos zugreifen
     * Achtung: Dies ist nur für Administratoren (dfrey) möglich
     *
    ...
    /**
     * Daten (Tage) an denen für den angegebenen Dozenten und die angegebene Prüfung
    ...
    /**
     * Daten (Tage) an denen für den angegebenen Dozenten und die angegebenen Prüfungen
     * Prüfungen durchgeführt werden
     *
     * @param dozent        LDAP-UserName des Dozenten
     * @param passwrd       LDAP-Passwort des Dozenten
