...
public class UPSWebServiceServiceLocator extends org.apache.axis.client.Service implements com.wegmueller.ups.webservice.stub.UPSWebServiceService {
    ...
    public UPSWebServiceServiceLocator(org.apache.axis.EngineConfiguration config) {
        super(config);
    }

    public UPSWebServiceServiceLocator(java.lang.String wsdlLoc, javax.xml.namespace.QName sName) throws javax.xml.rpc.ServiceException {
        super(wsdlLoc, sName);
    }

    // Use to get a proxy class for UPSWebService
    public static final java.lang.String DEFAULT_ADDRESS = "http://geobot1.ethz.ch:8080/upsserver/UPSWebService.jws";
    private java.lang.String UPSWebService_address = "http://geobot1.ethz.ch:8080/upsserver/UPSWebService.jws";
    ...
    public void setUPSWebServiceWSDDServiceName(java.lang.String name) {
    ...
    public com.wegmueller.ups.webservice.stub.UPSWebService getUPSWebService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.wegmueller.ups.webservice.stub.UPSWebServiceSoapBindingStub _stub = new com.wegmueller.ups.webservice.stub.UPSWebServiceSoapBindingStub(portAddress, this);
    ...
    public void setUPSWebServiceEndpointAddress(java.lang.String address) {
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.wegmueller.ups.webservice.stub.UPSWebService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.wegmueller.ups.webservice.stub.UPSWebServiceSoapBindingStub _stub = new com.wegmueller.ups.webservice.stub.UPSWebServiceSoapBindingStub(new java.net.URL(UPSWebService_address), this);
                _stub.setPortName(getUPSWebServiceWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://geobot1.ethz.ch:8080/upsserver/UPSWebService.jws", "UPSWebServiceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://geobot1.ethz.ch:8080/upsserver/UPSWebService.jws", "UPSWebService"));
        }
