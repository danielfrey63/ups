...
public class Splash extends JWindow
{
    ...
    public Splash( final ImageIcon imageIcon, final ch.jfactory.animation.AnimationQueue scroller )
    {
        final int width = imageIcon.getIconWidth();
        final int height = imageIcon.getIconHeight();
        final JLabel label = new JLabel( imageIcon );
    ...
    public static void main( final String[] args ) throws FileNotFoundException
    {
        ...
        final AnimationQueue scrollingComponent = new ch.jfactory.animation.AnimationQueue();
        ...
        final Paintable fader = new ch.jfactory.animation.fading.FadingPaintable( fadeColor );
