...
public class SimpleTransientGraphNode extends AbsSimpleGraphNode {
    ...
    private static final Category
            CAT = Category.getInstance(SimpleTransientGraphNode.class);
    ...
    public void addChild(final GraphNode child, final Role role) {
        CAT.info("SimpleTransientGraphNodes don't support roles.");
        addChild(child);
    }
    ...
    public void addChild(final int index, final GraphNode child, final Role role) {
        CAT.warn("SimpleTransientGraphNodes don't support roles.");
    ...
    public boolean deleteChild(final GraphNode child) {
        ...
        for (Iterator iter = list.iterator(); iter.hasNext();) {
            final GraphNode other = (GraphNode) iter.next();
