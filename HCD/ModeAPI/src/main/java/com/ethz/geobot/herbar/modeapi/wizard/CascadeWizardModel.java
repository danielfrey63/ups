...
/**
 * This WizardModel is used to has two models one is a static model and the cascade one which is dependent from the first one. The User should extends this class and use the setCascadeWizardModel method to set the cascaded WizardModel.
 *
