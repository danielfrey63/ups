...
public class PictureLoader {
    ...
    private static final Category cat = Category.getInstance(PictureLoader.class);
    ...
    public static Image load(final String pictureURL, final IIOReadProgressListener read, final IIOReadUpdateListener update,
        ...
        try {
            ...
            if (file.exists()) {
                ...
                cat.warn("No Image at " + pictureURL);
            }
        }
        catch (Exception ex) {
            ex.printStackTrace();
            cat.warn("Loading of image " + pictureURL + " failed.", ex);
        }
        return null;
    }
    ...
    public static Dimension getSize(final String pictureURL) {
        ...
        try {
            ...
            cat.error("Error while processing image " + pictureURL);
            throw ex;
        }
        finally {
            reader = null;
