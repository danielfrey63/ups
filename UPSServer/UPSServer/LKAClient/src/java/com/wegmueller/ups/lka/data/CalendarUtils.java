...
public class CalendarUtils {
    ...
    public static final Calendar parsePlanungFreigabe(String s) {
    ...
    public static Calendar parsePruefungsdatum(String pruefungsdatum) {
        return parsePlanungFreigabe(pruefungsdatum);
    }

    public static Calendar parseTime(Calendar datum, String vonStr) {
        Calendar c = parseTime(vonStr);
    ...
    private static Calendar parseTime(String vonStr) {
    ...
    public static Calendar parseSessionsEnded(String sessionsende) {
