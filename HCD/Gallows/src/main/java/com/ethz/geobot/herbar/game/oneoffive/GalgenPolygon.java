...
public class GalgenPolygon {
    ...
    private double diffX0, diffX1, diffX2, diffX3, diffY0, diffY1, diffY2,
            diffY3;
    private int[] iRightX = new int[4];
    private int[] iRightY = new int[4];
    private int[] iLeftX = new int[4];
    private int[] iLeftY = new int[4];
    private int[] iTopX = new int[4];
    private int[] iTopY = new int[4];
    private double[] dRightX = new double[4];
    private double[] dRightY = new double[4];
    private double[] dLeftX = new double[4];
    private double[] dLeftY = new double[4];
    private double[] dTopX = new double[4];
    private double[] dTopY = new double[4];
    private int counter;
     ...
     */
    public GalgenPolygon(double[] baseX, double[] baseY, double[] topX,
