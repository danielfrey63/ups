...
public class DumpUtils {
    ...
    public static void dumpStringArray(String[] stu) throws StorageException {
        for (int i = 0; i < stu.length; i++) {
            System.out.println(stu[i]);
        }
    }

    public static void dumpTest(IAnmeldedaten[] list, String[] stu) throws StorageException {
        try {
            ...
            for (int k = 0; k < list.length; k++) {
                IAnmeldedaten anm = list[k];
                boolean eingereicht = set.contains(anm.getStudentennummer());
    ...
    public static void dumpCalendars(Calendar[] pruefungsZeiten) {
