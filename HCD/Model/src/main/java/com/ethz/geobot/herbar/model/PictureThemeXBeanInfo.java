...
public class PictureThemeXBeanInfo implements JXPathBeanInfo {
    ...
    private final static Category cat = Category.getInstance(PictureThemeXBeanInfo.class);
    private Map descriptor = new HashMap();

    public PictureThemeXBeanInfo() {
        try {
            PropertyDescriptor des = new PropertyDescriptor("id", com.ethz.geobot.herbar.model.PictureTheme.class, "getId", null);
            descriptor.put("id", des);
            des = new PropertyDescriptor("name", com.ethz.geobot.herbar.model.PictureTheme.class, "getName", null);
