...
public class ComponentFactory
{
     ...
     * @return The button created
     */
    public static JToggleButton createToggleButton( final Class obj, final String prefix, final ActionListener actionListener )
    {
        final JToggleButton button = createSimpleToggleButton( obj, prefix, actionListener );
        final String shortcut = Strings.getString( obj, prefix + ".SHORT" );
        final KeyStroke key = KeyBindings.parseKeyStroke( shortcut );
        if ( key != null )
        {
    ...
    private static void registerKeyStroke( final AbstractButton button, final String resourceKey, final HierarchyListener owner )
    {
     ...
     * @return a new button
     */
    private static JToggleButton createSimpleToggleButton( final Class obj, final String prefix, final ActionListener actionListener )
    {
