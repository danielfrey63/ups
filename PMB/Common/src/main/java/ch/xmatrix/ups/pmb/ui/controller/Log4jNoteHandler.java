...
/**
 * Logs {@link ch.jfactory.binding.InfoModel InfoModel} change events to the {@link Logger}. If the {@link Note}s type
 * is {@link ch.jfactory.application.view.status.Message.Type#INFO INFO}, the message is issued to the loggers info,
 * otherwise to the error chanel.
 *
 * @author Daniel Frey
