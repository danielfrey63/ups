...
public class Carpet extends Canvas implements Runnable {
    ...
    private static final Category CAT = Category.getInstance(Carpet.class);

    private boolean threadRunning = false;
    private Image image;
    private Graphics offscreen;
    private FlyingFlower[] ff;
    private FlyingFlower[] fg;
    private FlyingBird[] fb;
    private EnergyBar eb;
    private FlyingBee bee;
    private FlyingEarth fe;
     ...
     */
    public Carpet(Catcher catcher, FlyingBee bee, FlyingFlower[] ff,
                  FlyingGras[] fg, FlyingBird[] fb, FlyingEarth fe, EnergyBar eb,
     ...
     */
    public void setFlyingCarpet(boolean flyC) {
        flyingCarpet = flyC;
    }
     ...
     */
    public void setFlyingBird(boolean flyB) {
        flyingBird = flyB;
    }
     ...
     */
    public void setRotatingBee(boolean rotB) {
        rotatingBee = rotB;
    }
     ...
     */
    public void setWiningBee(boolean winB) {
        winingBee = winB;
    }
