...
SET TABLE VERTICES_IMPORT SOURCE '2014-Vertices.tsv;fs=\t;ignore_first=true';
...
SET TABLE VERTICES_IMPORT SOURCE NULL;
DROP TABLE VERTICES_IMPORT;
...
SET TABLE EDGES_IMPORT SOURCE '2014-Edges.tsv;fs=\t;ignore_first=true';

INSERT INTO EDGES (SELECT * FROM EDGES_IMPORT);
SELECT * FROM EDGES_IMPORT;

SET TABLE EDGES_IMPORT SOURCE NULL;
