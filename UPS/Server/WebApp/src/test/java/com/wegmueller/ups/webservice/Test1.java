...
public class Test1 extends TestCase
{
    ...
    public void testStore1()
    {
        ...
        try
        {
            ...
            boolean found = false;
            for ( final IPruefung aC : c )
            {
                if ( aC.getLKNummer().equalsIgnoreCase( "551-0004-01" ) )
                {
                    assertEquals( aC.getTitle(), "Systematische Biologie: Pflanzen I / Systematische Biologie: Pflanzen II" );
                    found = true;
                }
            }
            assertTrue( found );
        ...
        try
        {
            ...
            boolean found = false;
            for ( final IAnmeldedaten aC : c )
            {
                if ( aC.getStudentennummer().equalsIgnoreCase( "01-909-100" ) )
                {
                    found = true;
                }
            }
