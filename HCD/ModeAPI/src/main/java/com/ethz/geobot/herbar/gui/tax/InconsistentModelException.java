...
/**
 * Exception that is thrown when the MorphologyListModel has a invalid context. An invalid context is found when a taxon is set, which is not part of the given siblings.
 *
