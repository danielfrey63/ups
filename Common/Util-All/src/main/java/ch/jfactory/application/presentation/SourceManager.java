...
/**
 * Ajusts the title of a frame according to the save state and dis-/enables the save action. Make sure the frame has its title set when this object is build. The title will be completed by the source name and an asterisk if the source has not been flushed.
 *
 * @author Daniel Frey
