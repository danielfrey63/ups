...
public class JSearchTree {
    ...
    private boolean isPrintableDefined(final char ch) {
        ...
        if (type == Character.UPPERCASE_LETTER) return true;
        if (type == Character.OTHER_LETTER) return true;
        if (type == Character.OTHER_NUMBER) return true;
        if (type == Character.OTHER_PUNCTUATION) return true;
        if (type == Character.OTHER_SYMBOL) return true;
        if (type == Character.SPACE_SEPARATOR) return true;
        if (type == Character.START_PUNCTUATION) return true;
        if (type == Character.TITLECASE_LETTER) return true;
        if (type == Character.CURRENCY_SYMBOL) return true;
        if (type == Character.DASH_PUNCTUATION) return true;
        if (type == Character.DECIMAL_DIGIT_NUMBER) return true;
        if (type == Character.ENCLOSING_MARK) return true;
        if (type == Character.END_PUNCTUATION) return true;
        if (type == Character.FINAL_QUOTE_PUNCTUATION) return true;
        if (type == Character.FORMAT) return true;
        if (type == Character.INITIAL_QUOTE_PUNCTUATION) return true;
        if (type == Character.LETTER_NUMBER) return true;
        if (type == Character.LINE_SEPARATOR) return true;
        if (type == Character.LOWERCASE_LETTER) return true;
        if (type == Character.MATH_SYMBOL) return true;
        if (type == Character.MODIFIER_LETTER) return true;
        if (type == Character.MODIFIER_SYMBOL) return true;
