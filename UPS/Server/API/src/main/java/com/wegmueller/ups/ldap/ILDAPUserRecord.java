...
/** Created by: Thomas Wegmueller Date: 26.09.2005,  18:06:30 */
public interface ILDAPUserRecord
{
    ...
    String KEY_MATRICULATION_NUMBER = "swissEduPersonMatriculationNumber";

    String KEY_DEPARTMENT = "departmentNumber";
