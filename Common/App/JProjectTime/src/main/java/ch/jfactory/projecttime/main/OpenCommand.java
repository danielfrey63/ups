...
public class OpenCommand extends ActionCommand
{
    ...
    protected void handleExecute()
    {
        try
        {
            ...
            if ( ret == JFileChooser.APPROVE_OPTION )
            {
                ...
                if ( data.entry2InvoiceMap != null )
                    model.getProjectModel().setEntry2InvoiceMap( data.entry2InvoiceMap );
    ...
    private void fixData( final IFEntry entry, final IFEntry parent )
    {
