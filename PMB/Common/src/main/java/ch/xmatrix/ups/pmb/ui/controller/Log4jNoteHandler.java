...
/**
 * Logs {@link InfoModel InfoModel} change events to the {@link Logger}. If the {@link Note}s type
 * is {@link Message.Type#INFO INFO}, the message is issued to the loggers info,
...
public class Log4jNoteHandler implements PropertyChangeListener
{
    ...
    public Log4jNoteHandler( final org.slf4j.Logger logger )
    {
        this.logger = logger;
    }
