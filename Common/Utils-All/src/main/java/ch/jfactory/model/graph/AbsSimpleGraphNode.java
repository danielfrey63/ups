...
public abstract class AbsSimpleGraphNode implements GraphNode, Serializable {
    ...
    private static final Category CAT = Category.getInstance(AbsSimpleGraphNode.class);
