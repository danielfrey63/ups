...
SET TABLE VERTICES_IMPORT SOURCE '2014-Vertices.tsv;encoding=UTF-8;fs=\t;ignore_first=true';
...
SET TABLE EDGES_IMPORT SOURCE '2014-Edges.tsv;encoding=UTF-8;fs=\t;ignore_first=true';
