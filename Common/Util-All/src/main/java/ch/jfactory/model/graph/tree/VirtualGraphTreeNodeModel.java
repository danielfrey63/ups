...
public class VirtualGraphTreeNodeModel implements GraphModel
{
    ...
    /**
     * I first try to find the next equal filter type, starting at the current filter and stepping upwards to the root filter. After the filter has been found, the corresponding GraphNode is searched.
     *
