 ...
 * implements {@link NotifiableTreeModel}, removal and insertion of nodes are supported. Otherwise an
 * IllegalStateException is thrown.
 *
 * <p/>After setting or removing the filter, the model is automatically reloaded. As a side-effect, nodes are collapsed.
 * If you want to keep the expanded states of the nodes, consider to use {@link TreeExpandedRestorer}.
 *
 * @author Daniel Frey
