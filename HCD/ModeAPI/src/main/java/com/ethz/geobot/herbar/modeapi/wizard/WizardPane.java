...
/**
 * Super class for all wizard panes. All wizard panes must be inherit from this class. It enhance JPanel with some
 * wizard related features.
 *
...
public abstract class WizardPane extends JPanel
{
     ...
     * to overwrite this method, it is guaranteed that the panel is properly bordered by a edged border with the correct
     * insets.
     *
     ...
     * is displayed in a field with the panels background color, but without scrolling object.<p> Overwrite this method
     * if you want to have another text display than the default. This will change all default text displays.
     *
    ...
    /**
     * Is invoked by the wizard if it enter this pane. Overwrite this method if you want to take actions upon
     * activation.
     */
    ...
    /**
     * Is invoked by the wizard if it leaves this pane. Overwrite this method if you want to take actions upon
     * activation.
     */
