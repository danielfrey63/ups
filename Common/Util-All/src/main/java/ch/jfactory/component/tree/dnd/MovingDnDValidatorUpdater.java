...
/**
 * Simple implementation of an <code>AbstractDnDValidatorUpdater</code> that provides support for moving nodes around. Shifting nodes left and right is not supported. Moving nodes into children of themselves is suppressed.
 *
 * @author Daniel Frey
