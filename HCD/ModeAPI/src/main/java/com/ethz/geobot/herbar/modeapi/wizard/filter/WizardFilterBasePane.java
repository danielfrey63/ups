...
public class WizardFilterBasePane extends WizardPane {
    ...
    public WizardFilterBasePane(String basePropertyName) {
    ...
    protected JPanel createDisplayPanel(String prefix) {
        ...
        JPanel baseText = createTextPanel(prefix);
    ...
    private EditItem createBasePanel(String prefix) {
        ActionListener actionListener = new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                if (!isVisible()) {
                    return;
                }
                JDialog parent = (JDialog) WizardFilterBasePane.this.getTopLevelAncestor();
                ...
                Object currentModel = getProperty(FilterWizardModel.FILTER_MODEL);
                ...
                ListDialog dialog = new ListDialog(parent, "DIALOG.BASELISTS", listContent);
                ...
                if (dialog.isAccepted()) {
                    Object newBase = dialog.getSelectedData()[ 0 ];
