...
class UPSServerClientException extends Throwable {
    ...
    public UPSServerClientException(String reason, Throwable e) {
        super(e);
        this.reason = reason;
    }

    public UPSServerClientException(String reason) {
        super(REASON2MESSAGE(reason));
        this.reason = reason;
    }

    public static String REASON2MESSAGE(String reason) {
