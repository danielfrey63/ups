...
public class TestStorageSystem extends TestCase {
    ...
    public void testSaveAnmdeldung() {
        TestAnmeldung d = new TestAnmeldung();
        ...
        try {
            IPruefung[] ad = system.getPruefungen(TestAnmeldung.SESKEZ, TEST_DOZENT);
            assertNotNull(ad);
            assertEquals(1, ad.length);
    ...
    private void assertSameDay(Calendar cal1, Calendar cal2) {
        GregorianCalendar c1 = new GregorianCalendar(cal1.get(Calendar.YEAR),cal1.get(Calendar.MONTH),cal1.get(Calendar.DAY_OF_MONTH));
        GregorianCalendar c2 = new GregorianCalendar(cal2.get(Calendar.YEAR),cal2.get(Calendar.MONTH),cal2.get(Calendar.DAY_OF_MONTH));
        assertEquals(c1,c2);
    }


    public void testSaveAnmdeldung2() {
        String nummer1 ="nummer1";
        String nummer2 ="nummer2";
        String nummer3 ="nummer3";
        ...
        TestAnmeldung d1 = new TestAnmeldung();
        ...
        TestAnmeldung d2 = new TestAnmeldung();
        ...
        try {
            Calendar[] am = system.getPruefungsZeiten(TestAnmeldung.SESKEZ, TestAnmeldung.LK_NUMMER, TEST_DOZENT);
            assertNotNull(am);
    ...
    public void savePruefungsSession() {
        PruefungsSession s = new PruefungsSession();
        ...
        assertNull(e);
        try {
            IPruefungsSession[] retSes = system.getPruefungssessionen();
        ...
        try {
            IPruefungsSession ps = system.getPruefungsSessionByID(TestAnmeldung.SESKEZ);
            ...
            assertTrue(((PruefungsSession) ps).getStorageDate().compareTo(new GregorianCalendar()) < 0);
            assertTrue(((PruefungsSession) ps).getStorageDate().compareTo(testDate) > 0);
        } catch (Throwable ex) {
            ex.printStackTrace();
            e = ex;
        }
    ...
    public void testStorePruefungsListe() {
        byte[] pdf1 = "abc".getBytes();
        byte[] pdf2 = "def".getBytes();
        byte[] pl1 = "abc".getBytes();
        byte[] pl2 = "def".getBytes();
