...
/**
 * mode-class of game oneoffive. Todo: Remove optical illusion of birds fly. Todo: HangMan moves to the left when texts are to braod. Todo: Signal an appropriate successful end of game. Todo: Ask for "really exit" only if game is running. Explain that the game will be terminated.
 *
