...
public class Version implements Comparable {
    ...
    public int compareTo(final Object o) {
        ...
        if (o == null) { // Todo: Doublecheck sense of this statement
            return 1;
        }
        final Version other = (Version) o;
        if (other.versions == null) { // Todo: Doublecheck sense of this statement
            return 1;
        }
        ...
        for (i = 0; i < minLength; i++) {
            result = new Integer(versions[i]).compareTo(new Integer(other.versions[i]));
            if (result != 0) {
                break;
            }
        }
